...
@extends('layouts.app')
@section('title', "Indonesian Art's")
@section('content')
...
<div class="container py-5">
  <h1 class="text-center text-danger fw-bold mb-4 h1">Indonesian Art's</h1>

  <div class="container mb-5">
    <div class="d-flex justify-content-end">
      <span class="input-group-text border-end border"><i class="bi bi-search"></i></span>
      <input type="text" class="form-control" style="max-width: 300px;" placeholder="Search arts">
    </div>
  </div>
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card border-0 rounded-5">
            <div class="ratio ratio-1x1">
              <img src="{{ $item['main_image'] ?? 'https://source.unsplash.com/400x300/?art' }}" class="card-img-top rounded-5 object-fit-cover" alt="{{ $item['name'] ?? 'Indonesian Art' }}">
            </div>
            <div class="card-body text-center">
              <h5 class="card-title h6">{{ $item['name'] ?? 'Art Name' }}</h5>
    ...
    @else
      <div class="col-12">
        <div class="alert alert-info text-center" role="alert">
          Belum ada karya seni yang tersedia.
        </div>
      </div>
    @endif
    </main>
